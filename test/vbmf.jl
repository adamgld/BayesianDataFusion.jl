...
@test_approx_eq Uv      [1.0/3.0 1.0/3.0 1.0/5.0]
@test_approx_eq Um      [2.0/3.0 3.0/3.0 5.0/5.0]
@test_approx_eq R[3,1]  2.0 - 2.0/3.0
@test_approx_eq R[1,2]  3.0 - 1
@test_approx_eq R[1,3]  2.0 - 1 
@test_approx_eq R[2,3]  3.0 - 1 
...
BayesianDataFusion.update_latent!(R, Um, Uv, alpha, tau, Vm, Vv, Am, F)
@test_approx_eq Uv      [1.0/3.0 1.0/3.0 1.0/5.0]
@test_approx_eq Um      [2.1/3.0 3.1/3.0 5.1/5.0]
@test_approx_eq R[3,1]  2.0 - 2.1/3.0
@test_approx_eq R[1,2]  3.0 - 3.1/3.0
@test_approx_eq R[1,3]  2.0 - 5.1/5.0
@test_approx_eq R[2,3]  3.0 - 5.1/5.0
